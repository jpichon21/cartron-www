 ...
 */
class VideoHp extends \Site\CartronBundle\Entity\VideoHp implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setVideoFr($videoFr);
    }

    public function getVideoFr()
    {
        $this->__load();
        return parent::getVideoFr();
    }
    ...
    {
        $this->__load();
        return parent::setVideoEn($videoEn);
    }

    public function getVideoEn()
    {
        $this->__load();
        return parent::getVideoEn();
    }
    ...
    {
        return array('__isInitialized__', 'videoFr', 'titreFr', 'videoEn', 'titreEn', 'id');
    }
