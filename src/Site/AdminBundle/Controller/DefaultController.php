...
//            }
    ...
    public function sousMenuAction(Request $request) {
        ...
        $id = $request->query->get('id');
        if (isset($id))
            $sousMenu = $em->getRepository('SiteCartronBundle:SousMenu')->findBy(array('idCollection' => $id),array('idCollection' => 'ASC'));
        else
            $sousMenu = $em->getRepository('SiteCartronBundle:SousMenu')->findAll(array(), array('idCollection' => 'ASC'));
