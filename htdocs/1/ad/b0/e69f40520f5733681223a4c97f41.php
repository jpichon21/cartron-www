...
class __TwigTemplate_adb0e69f40520f5733681223a4c97f41 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        echo "\" href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("site_cartron_collection_produit", array("id" => $this->getAttribute($this->getAttribute((isset($context["sousMenu"]) ? $context["sousMenu"] : $this->getContext($context, "sousMenu")), 0), "id"))), "html", null, true);
        echo "\" >
    ";
        // line 2
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
            echo " ";
            echo (isset($context["titreEn"]) ? $context["titreEn"] : $this->getContext($context, "titreEn"));
            echo " ";
        } else {
            echo " ";
            echo (isset($context["titreFr"]) ? $context["titreFr"] : $this->getContext($context, "titreFr"));
            echo " ";
        }
        // line 3
        echo "</a>";
