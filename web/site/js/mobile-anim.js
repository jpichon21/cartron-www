...
if (screen.width <= 568) {
    ...
    $( document ).ready(function() {
        ...
        $('.savoir-faire-creation img').css("left", "-372px");
        ...
        var i = 0;
            ...
            function moveImgSlow(){
                $('.savoir-faire-creation img').css({"left" : "-300px", "transition" : "2s ease-in"});
                setTimeout(function(){moveImgBlur();}, 1800);
            };

            function moveImgBlur(){
                $('.savoir-faire-creation img').css({"left" : "0px", "transition" : "2s ease-in"});
            ...
            function showTitleContent(){
                ...
                $('.savoir-faire-creation h2').css("transition", "2s ease-in");
                $('.savoir-faire-creation .retour').css("transition", "3s ease-in");
            ...
            function ShowTextContent(Step, ShowTimer, i){
                    i = i + 1;
                    $('.link-liqueur, .link-eau-vie-home').css({"opacity" : "1", "transition" : "2s ease-in" });
                    $('.desc-creation p:nth-child('+ i + ')').css({"opacity" : "1", "transition" : "2s ease-in"});
                    setTimeout(function(){ShowTextContent(ShowTimer, Step, i);}, ShowTimer);
            };

            function ShowFooterMenu(){
                $('.savoir-faire-creation .link-creation-bt').css({"opacity" : "1", "transition" : "2s ease-in"});
            }
