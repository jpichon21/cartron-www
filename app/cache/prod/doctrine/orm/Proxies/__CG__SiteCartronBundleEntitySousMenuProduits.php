 ...
 */
class SousMenuProduits extends \Site\CartronBundle\Entity\SousMenuProduits implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'titreFr', 'titreEn', 'id');
    }
