...
class __TwigTemplate_3aa4407f1ec4f9be66f55debf29ea2b3 extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
          ...
          <div class=\"blockDesc\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sm"]) {
                // line 35
                echo "                ";
                if (($this->getAttribute($this->getAttribute((isset($context["sm"]) ? $context["sm"] : $this->getContext($context, "sm")), "idCollection"), "id") == $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "id"))) {
                    // line 36
                    echo "                <li>
                  <a href=\"";
                    // line 37
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("site_cartron_collection_produit", array("id" => $this->getAttribute((isset($context["sm"]) ? $context["sm"] : $this->getContext($context, "sm")), "id"))), "html", null, true);
                    echo "\">
                    ";
                    // line 38
                    if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                        echo " ";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["sm"]) ? $context["sm"] : $this->getContext($context, "sm")), "titreEn"), "html", null, true);
                        echo " ";
                    } else {
                        echo " ";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["sm"]) ? $context["sm"] : $this->getContext($context, "sm")), "titreFr"), "html", null, true);
                        echo " ";
                    }
                    // line 39
                    echo "                  </a>
