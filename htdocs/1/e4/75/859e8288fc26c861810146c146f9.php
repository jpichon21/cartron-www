...
class __TwigTemplate_e475859e8288fc26c861810146c146f9 extends Twig_Template
{
...
<script type=\"text/javascript\">
    ...
    {
    \t
    \tnew cartron.Responsive({'\$container':\$('#home'), 'offset':82})
    \t
    ...
    <div class=\"caroussel-home\">
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session"), "get", array(0 => "_locale"), "method") == "en")) {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "video"), 0), "titreEn"), "html", null, true);
            echo " ";
        } else {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "video"), 0), "titreFr"), "html", null, true);
            echo " ";
        }
        echo "</span></a></h2>
        ...
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("upload/" . $this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "image"))), "html", null, true);
        echo "\" alt=\"\" /></a>
                <div class=\"txt-video-news-home\">
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session"), "get", array(0 => "_locale"), "method") == "en")) {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "titreEn"), "html", null, true);
            echo " ";
        } else {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "titleFr"), "html", null, true);
            echo " ";
        }
        echo "</span></a></h2>
                    <p>";
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session"), "get", array(0 => "_locale"), "method") == "en")) {
            echo " ";
            echo twig_truncate_filter($this->env, strip_tags($this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "descEn")), 100, true, "...");
            echo " ";
        } else {
            echo " ";
            echo twig_truncate_filter($this->env, strip_tags($this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "descFr")), 100, true, "...");
            echo " ";
        }
        echo "</p>
                </div>
    ...
    <div class=\"overlay-news overlay\">
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session"), "get", array(0 => "_locale"), "method") == "en")) {
            echo " ";
            echo $this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "descEn");
            echo " ";
        } else {
            echo " ";
            echo $this->getAttribute($this->getAttribute($this->getContext($context, "articles"), 0), "descFr");
            echo " ";
        }
        // line 62
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                ...
                echo " ";
                echo $this->getAttribute($this->getContext($context, "article"), "titleFr");
                echo " ";
            }
            echo "</h3></li>
                ";
