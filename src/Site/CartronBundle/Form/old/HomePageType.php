...
class HomePageType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('descFr','textarea',array('required' => true,'attr' => array('class' => 'tinymce', 'tinymce'=>'{"theme":"simple"}')))
            ->add('titreEn','text',array('required' => true))
            ->add('descEn','textarea',array('required' => true,'attr' => array('class' => 'tinymce', 'tinymce'=>'{"theme":"simple"}')))
