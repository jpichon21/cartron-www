...
$( document ).ready(function() {
    ...
    var i = 0;
        ...
        function moveImgSlow(){
            ...
            $('.savoir-faire-creation img').css("transition", "2s ease-in-out");
            setTimeout(function(){moveImgBlur();}, 1800);
        };

        function moveImgBlur(){
            $('.savoir-faire-creation img').css("left", "0px");
            $('.savoir-faire-creation img').css("transition", "2s ease-in-out");
        ...
        function showTitleContent(){
            ...
            $('.savoir-faire-creation h2').css("transition", "2s ease-in-out");
            $('.savoir-faire-creation .retour').css("transition", "3s ease-in-out");
        ...
        function ShowTextContent(Step, ShowTimer, i){
                i = i + 1;
                $('.desc-creation p:nth-child('+ i + ')').css("opacity", "1");
                $('.desc-creation p:nth-child('+ i + ')').css("transition", "2s ease-in-out");
                setTimeout(function(){ShowTextContent(ShowTimer, Step, i);}, ShowTimer);
        };

        function ShowFooterMenu(){
            $('.savoir-faire-creation .link-creation-bt').css("opacity", "1");
            $('.savoir-faire-creation .link-creation-bt').css("transition", "2s ease-in-out");
