...
class __TwigTemplate_45f998846b21b169c6f7cc059ec1933d extends Twig_Template
{
...
<div id=\"collection-produits\" class=\"test2\">
  <style>
    .collection-home .menu_collection #marc_";
        // line 47
        echo twig_escape_filter($this->env, (isset($context["idcollection"]) ? $context["idcollection"] : $this->getContext($context, "idcollection")), "html", null, true);
        echo " a{
    border-bottom:2px solid #";
        // line 48
        echo twig_escape_filter($this->env, (isset($context["defaultColor"]) ? $context["defaultColor"] : $this->getContext($context, "defaultColor")), "html", null, true);
        echo ";
    }
    ...
    <div class=\"collection-home\">
      <div class=\"menu_collection\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            ";
            // line 83
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("SiteCartronBundle:Default:lienMenuPageCollection", array("id" => $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "id"), "titreEn" => $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "titreEn"), "titreFr" => $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "titreFr"), "rid" => "")));
            echo "
          </li>
          <style>
            .collection-home .menu_collection #marc_";
            ...
            border-bottom:2px solid #";
            // line 87
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "color"), "html", null, true);
            echo ";
            }
          </style>
          ";
...
\t
        ...
        // line 99
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["sousMenu"]) ? $context["sousMenu"] : $this->getContext($context, "sousMenu")));
        $context['loop'] = array(
        ...
        <div  data-thumb=\"";
            // line 101
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("upload/" . $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "icone"))), "html", null, true);
            echo "\" data-src=\"";
          ...
          <div class=\"camera_effected\">
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "titreEn"), "html", null, true);
                echo " ";
            } else {
                echo " ";
            ...
            <div class=\"description\">
              ";
            // line 108
            if (($this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "id") == $this->getAttribute((isset($context["articleDefault"]) ? $context["articleDefault"] : $this->getContext($context, "articleDefault")), "id"))) {
                // line 109
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "descriptionEn");
                echo " ";
            } else {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "descriptionFr");
                echo " ";
            }
            // line 114
            ...
            echo " :</span> ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "degre"), "html", null, true);
            echo "%</p>
                <p class=\"marge9\"><span>";
            // line 115
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "contenanceEn"), "html", null, true);
                echo " ";
            } else {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "contenanceFr"), "html", null, true);
                echo " ";
            }
            echo "</p>
                <p class=\"marge9\"><span>";
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "conserverEn"), "html", null, true);
                echo " ";
            } else {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "conserverFr"), "html", null, true);
                echo " ";
            }
            echo "</p>
              </div>
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "noteDegustationEn");
                echo " ";
            } else {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "noteDegustationFr");
                echo " ";
            }
            // line 121
            echo "              </div>
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "elaborationEn");
                echo " ";
            } else {
                echo " ";
                echo $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "elaborationFr");
                echo " ";
            }
            // line 125
            echo "              </div>
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "session"), "get", array(0 => "_locale"), "method") == "en")) {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "recetteEn"), "html", null, true);
                echo " ";
            } else {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["article"]) ? $context["article"] : $this->getContext($context, "article")), "recetteFr"), "html", null, true);
                echo " ";
            }
