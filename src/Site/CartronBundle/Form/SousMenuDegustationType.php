...
class SousMenuDegustationType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('noteDegustationFr', 'textarea', array('required' => false, 'attr' => array('class' => 'tinymce', 'tinymce' => '{"theme":"simple"}')))
                ...
                ->add('noteDegustationEn', 'textarea', array('required' => false, 'attr' => array('class' => 'tinymce', 'tinymce' => '{"theme":"simple"}')))
